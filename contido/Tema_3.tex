...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|}
      ...
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering Se selecciona de la lista de acciones una acción para ejecutar sobre el reparto.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{SELECCIONAR:} \\ Lista\_Acciones $\rightarrow$ Acción\_Borrar;} & \multicolumn{1}{|p{4.0cm}|}{\centering De la lista, se selecciona una acción de borrado.}\\
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering Seleccionada una acción, se aplica sobre el reparto.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{MODIFICAR:}: Accion\_Borrar $\rightarrow$ Reparto.item\_reparto.modificable = true;} & \multicolumn{1}{|p{4.0cm}|}{\centering Se borra el elemento que ha violado los requisitos del reparto.}\\
      \hline  
    \end{tabular}
  }
...
La empresa actualmente cuenta con tres rutas, conocidas como \textbf{Ruta A, Ruta B} y \textbf{Ruta C}, para efectuar el reparto en la zona según el contrato con la central de MRW, con la siguiente situación donde se tiene una lista de paquetes asignados a la Ruta B. En ese listado se encuentran paquetes de solamente un tipo, es decir, paquetes normales. El sistema tiene que asignar un vehículo apropiado para efectuar el reparto en cuestión. En la Tabla \ref{tab:EjemploEscenario12} muestra un desglose:
