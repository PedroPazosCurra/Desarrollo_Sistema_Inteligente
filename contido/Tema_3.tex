...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|}
      ...
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering Seleccionada una acción, se aplica sobre el reparto.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{MODIFICAR:}: Accion\_Borrar $\rightarrow$ Reparto;} & \multicolumn{1}{|p{4.0cm}|}{\centering Se borra el elemento que ha violado los requisitos del reparto.}\\
      \hline  
    \end{tabular}
  }
