...
La Figura \ref{fig:Especificar} muestra el mapeo de la inferencia \textbf{Especificar}.
...
La Figura \ref{fig:TrasladarPreferibles} muestra el mapeo de la inferencia \textbf{Requisitos preferibles}.
...
La Figura \ref{fig:TrasladarObligatorios} muestra el mapeo de la inferencia \textbf{Requisitos obligatorios}.
