...
La tarea elegida para este modelo conceptual ha sido la tarea 3 del OM-3 (Tabla \ref{tab:IdentificacionOM3}), que se corresponde con \textbf{Determinar los recursos disponibles por la sucursal MRW para entregar según ruta}.
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|c|}
      ...
      \hline
      \vdots & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} \\
      \hline
      50 & \multicolumn{1}{|p{3.0cm}|}{\centering 100x50x40} & \multicolumn{1}{|p{3.0cm}|}{\centering 15} & \multicolumn{1}{|p{3.0cm}|}{\centering frio} \\
      \hline
    \end{tabular}
  }
	\caption{\label{tab:AsignarRecursoRutaA}Lista de paquetes asignados a la Ruta A con peso total de 700kg}
\end{table}
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|c|}
      ...
      2 & \multicolumn{1}{|p{3.0cm}|}{\centering 200x200x200} & \multicolumn{1}{|p{3.0cm}|}{\centering 20} & \multicolumn{1}{|p{3.0cm}|}{\centering normal} \\
      \hline

      \vdots & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} & \multicolumn{1}{|p{3.0cm}|}{\centering \vdots} \\
      \hline
      
      40 & \multicolumn{1}{|p{3.0cm}|}{\centering 100x50x40} & \multicolumn{1}{|p{3.0cm}|}{\centering 15} & \multicolumn{1}{|p{3.0cm}|}{\centering normal} \\
      \hline
    \end{tabular}
  }
	\caption{\label{tab:AsignarRecursoRutaB}Lista de paquetes asignados a la Ruta B con peso total de 500kg}
\end{table}
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|}
      ...
      \hline \hline      
      \multicolumn{1}{|p{5.0cm}|}{\centering Nuestro sistema recibe como requisitos una lista de paquetes asignada a la ruta A con su información correspondiente. }& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{REQUISITOS:} \\ Peso total = 700.0 \\ Volumen total = 10.5 \\ Requisito de peso = 80\% \\ Requisito de volumen = 70\% } & \multicolumn{1}{|p{4.0cm}|}{\centering Se reciben requisitos, el peso y el volumen de un conjunto de paquetes. Estos serán comparados con los requisitos para asegurar la correcta distribución de un reparto.}\\
      \hline
      \multicolumn{1}{|p{5.0cm}|}{\centering Los requisitos son trasladados dividiéndolos entre obligatorios y preferibles. La carga máxima debe ser el 80\% del peso del vehículo y el volumen máximo debe ser el 70\%. \\ }& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{TRASLADAR:} \\ Peso total $\rightarrow$ Reparto.peso\_total \\ Volumen total → Reparto.volumen\_total \\ Req\_Ob\_Peso.peso\_value = 80 \\ Req\_Ob\_Volumen.volumen\_value = 70 \\} & \multicolumn{1}{|p{4.0cm}|}{\centering Los datos de entrada son trasladados al sistema y divididos entre requisitos obligatorios (req. peso, req. volumen) y preferibles (tipo).}\\
      \hline     
      \multicolumn{1}{|p{5.0cm}|}{\centering Se propone un reparto que cumple los requisitos con un peso total de 700 kg y un volumen total de 10.5 $m^3$}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{PROPONER:} \\ Reparto.item\_seleccionado = SeleccionarPaquetes(Req\_pr\_tipo.Normal) ;} & \multicolumn{1}{|p{4.0cm}|}{\centering Dados los datos, se propone un reparto. Se propone un paquete de forma aleatoria de la lista de reparto y un conjunto de tipos.}\\
      \hline
      \multicolumn{1}{|p{5.0cm}|}{\centering Se recibe un reparto para que se compruebe si cumple los requisitos obligatorios.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{VERIFICAR:} \\ Reparto.Peso\_total >= Vehiculo.Peso\_Max * Requisito.Req\_Ob\_Peso.Peso\_value/100 $\rightarrow$  Reparto.Parametro.Valor = false;\\ Vehiculo.violacion = V\_Peso;} & \multicolumn{1}{|p{4.0cm}|}{\centering Con la información aportada, concluímos que este reparto propuesto da una violación por peso, pues 700 kg >= 80\% del peso máximo del vehículo. Denegamos este reparto y devuelve la violación por peso.}\\
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering El reparto anterior tuvo una violación de peso en la fase de verificación}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{CRITICAR:} \\ Reparto.vehiculo.violacion == V\_Peso; \\ disponibilidad\_vehiculos == true $\rightarrow$ \\  new(Accion\_Mover) ;} & \multicolumn{1}{|p{4.0cm}|}{\centering Debido al tipo de violación, se devuelve una lista de acciones posibles que cumplen preferentemente los requisitos preferibles y que permiten dejar de cometer la violación.}\\
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering Se selecciona de la lista de acciones una acción para ejecutar sobre el reparto.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{SELECCIONAR:} \\ Reparto.Accion = Accion\_Mover; \\  } & \multicolumn{1}{|p{4.0cm}|}{\centering De la lista, se selecciona una acción de mover.}\\
      \hline  
      \multicolumn{1}{|p{5.0cm}|}{\centering Seleccionada una acción, se aplica sobre el reparto.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{MODIFICAR:}: Reparto.Accion.aplicar(Reparto.item\_seleccionado.tipo) ;} & \multicolumn{1}{|p{4.0cm}|}{\centering Se mueve el elemento que ha violado los requisitos del reparto a un vehículo de su tipo.}\\
      \hline  
    \end{tabular}
  }
...
La empresa actualmente cuenta con tres rutas, conocidas como \textbf{Ruta A, Ruta B} y \textbf{Ruta C}, que efectuan el reparto por zonas según el contrato con la central de MRW. Se presenta la siguiente situación, donde se tiene una lista de paquetes asignados a la Ruta B. En ese listado, aparece un único tipos de paquetes, concretamente, paquetes normales. El sistema tiene que asignar un vehículo apropiado para efectuar el reparto en cuestión. En la Tabla \ref{tab:EjemploEscenario12} muestra un desglose:
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|}
      ...
      \multicolumn{1}{|c}{\textbf{Dominio}} & \multicolumn{1}{|c|}{\textbf{Modelo}}& \multicolumn{1}{|c|}{\textbf{Explicación}}\\
      \hline \hline      
      \multicolumn{1}{|p{5.0cm}|}{\centering Nuestro sistema recibe como requisitos una lista de paquetes asignada a la ruta B con su información correspondiente. }& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{REQUISITOS:} Peso total = 500.0 \\ Volumen total = 7.5 \\ Requisito de peso = 80\% \\ Requisito de volumen = 70\% } & \multicolumn{1}{|p{4.0cm}|}{\centering Se reciben requisitos y el peso y volumen de un conjunto de paquetes que serán comparados con los requisitos para asegurar la correcta distribución de un reparto}\\
      \hline
      \multicolumn{1}{|p{5.0cm}|}{\centering Los requisitos son trasladados dividiéndolos entre obligatorios y preferibles. La carga máxima debe ser el 80\% del peso del vehículo y el volumen máximo debe ser el 70\%. \\ }& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{TRASLADAR:} \\ Peso total $\rightarrow$ Reparto.peso\_total \\ Volumen total $\rightarrow$ Reparto.volumen\_total \\ Req\_Ob\_Peso.peso\_value = 80 \\ Req\_Ob\_Volumen.volumen\_value = 70 \\} & \multicolumn{1}{|p{4.0cm}|}{\centering Los datos de entrada son trasladados al sistema y divididos entre requisitos obligatorios (req. peso, req. volumen) y preferibles (tipo).}\\
      \hline     
      \multicolumn{1}{|p{5.0cm}|}{\centering Se propone un reparto que cumple los requisitos con un peso total de 500 kg y un volumen total de 7.5 $m^3$}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{PROPONER:} \\ Reparto.item\_seleccionado = SeleccionarPaquetes(Req\_pr\_tipo.Frio) ;} & \multicolumn{1}{|p{4.0cm}|}{\centering Dados los datos, es propuesto un reparto. Se propone un paquete de forma aleatoria de la lista de reparto y un conjunto de tipos.}\\
      \hline
      \multicolumn{1}{|p{5.0cm}|}{\centering Se recibe un reparto para que se compruebe si cumple los requisitos obligatorios.}& \multicolumn{1}{|p{10.0cm}|}{\centering \textbf{VERIFICAR:} \\ Reparto.Peso\_total <= Vehiculo.Peso\_Max * Requisito.Req\_Ob\_Peso.Peso\_value/100 $\rightarrow$  Reparto.Parametro.Valor = true;} & \multicolumn{1}{|p{4.0cm}|}{\centering Con la información aportada, concluímos que este reparto propuesto es correcto. Aprobamos este reparto.}\\
      \hline  
    \end{tabular}
  }
