	...
	\scriptsize
  	\resizebox{14,2cm}{!}{
		\begin{tabularx}{\textwidth}{|l|X|} 
			...
			\textsc{Tarea} & \textbf{Tarea 1:} \textit{Recepción de los paquetes en la sucursal MRW (entrada)} \\ 
			\hline
...
\begin{table}[H]
	...
	\caption{\label{tab:TM2}Formulario TM-2: Analisis de cuellos de botella en la Tarea 5 - (Experiencia en reparto de paquetes...))}
  \end{table}
  ...
  \begin{table}[H]
	...
	\resizebox{15.0cm}{!}{
	  \begin{tabular}{|l|l|l|} 
		...
		Electrónica & \multicolumn{1}{p{1.0cm}|}{Sí} & \multicolumn{1}{p{13.0cm}|}{No}\\
		\hline
	...
	\caption{\label{tab:TM22}Formulario TM-2: Analisis de cuellos de botella en la Tarea 5 - (Experiencia en distribución de recursos...)}
  \end{table}
