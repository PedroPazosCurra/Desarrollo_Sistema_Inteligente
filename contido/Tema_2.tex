  	...
  	\resizebox{14,2cm}{!}{
		\begin{tabularx}{\textwidth}{|l|X|} 
			...
			\textsc{Tiempo y control} & 
				\begin{enumerate}
					\item \textbf{Frecuencia y duración:} \textit{Es una tarea que se realiza a la primera hora de cada jornada. La duración es de una hora (aproximadamente).}
					\item \textbf{Control:} \textit{Comprobar que la lista ordenada se ha creado perfectamente y es lógico pensar que dependerá del tamaño de carga del vehículo y de la dimensiones/peso de la paquetería.}
