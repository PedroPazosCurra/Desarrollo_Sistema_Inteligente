...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|X|} 
		...
		\textsc{Tarea} & Tarea 1 - Recibimiento de los paquetes en la sucursal MRW (entrada)\\ 
		\hline
		\textsc{Organización}  & Logística.\\ 
		\hline
		\textsc{Objetivo y valor} &  Es una parte obligatoria de todo el proceso.\\ 
		\hline
		\textsc{Dependencia y Flujos} & \textit{1. Tareas precedentes:} Ninguna\\ &  \textit{2. Tareas que le siguen:} Tarea 2 \\
		\hline
		\textsc{Objetos manipulados} & \textit{1. Objetos de entrada de la tarea:} Información de los datos de los paquetes (a través de las herramientas de lectura de códigos de barras o códigos QR), Información recibida por el sistema de gestión de paquetes de MRW (Sistema suministrado por la empresa autora de la franquicia).\\ & \textit{2. Objetos de salida de la tarea:} información de la ruta adjudicada al paquete.\\  & \textit{3. Objetos internos:} conocimiento de los  expertos inversores en bolsa. \\ & \emph{Todos estos objetos incluyen elementos de información y conocimiento.}\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|X|} 
		...
		\textbf{Modelo de Tareas} & \textbf{Formulario TM-1: Análisis de Tareas} \\ 
		\hline\hline
		\textsc{Tarea} & Tarea 2 - Generar lista de entregas según ruta asignada.\\ 
		\hline
		...
		\hline
	\end{tabularx}
	\caption{\label{tab:TM1T3}Formulario TM-1: Analisis de tarea 2 del OM-3}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|X|} 
		...
		\textbf{Modelo de Tareas} & \textbf{Formulario TM-1: Análisis de Tareas} \\ 
		\hline\hline
		\textsc{Tarea} & Tarea 3 - Determinar los recursos disponibles por la sucursal MRW para entregar según ruta \\ 
		\hline
		\textsc{Organización}  & Departamento de Análisis.\\ 
		\hline
		\textsc{Objetivo y valor} &  Es una parte esencial de la expeculación en los mercados de divisas.\\ 
		...
		\hline
	\end{tabularx}
	\caption{\label{tab:TM1T4}Formulario TM-1: Analisis de tarea 3 del OM-3}
\end{table} 
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|l|X|} 
		...
		\textbf{Modelo de Tareas} & \textbf{Formulario TM-1: Análisis de Tareas} \\ 
		\hline\hline
		\textsc{Tarea} & Tarea 4 - Revisión y validación de la distribución de la paquetería. \\ 
		\hline
		\textsc{Organización}  & Departamento de Análisis.\\ 
		\hline
		\textsc{Objetivo y valor} &  Es una parte esencial de la expeculación en los mercados de divisas.\\ 
