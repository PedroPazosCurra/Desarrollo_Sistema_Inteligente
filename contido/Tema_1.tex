...
\textsc{Problemas y Oportunidades} & La logística es una parte muy importante en cualquier empresa que quiera maximizar al máximo sus recursos. Una empresa que posee una franquicia de una empresa importante de gestión de paquetería en España (MRW) nos contracta para desarrollar un sistema inteligente para mejorar su forma de gestionar los recursos de entrega y recogida de paqueterías \\ \hline
\textsc{Contexto Organizacional} & 
\begin{enumerate}
  \item La Misión, visión y objetivos de la organización son:  
  \begin{enumerate}
    \item \textbf{Misión:} Una pequeña empresa de distribución de paquetería. 
    \item \textbf{Visión:} Dando continuidad al sistema de automación de la logística de la empresa, que ya cuenta con un sistema de prioridad de entrega según la ruta asignada. 
    \item \textbf{Objetivos:} Maximizar al máximo los recursos que posee la empresa para gestionar las paqueterías que se recibe por parte de la central de MRW con el propósito de poder entregar/recoger mayor número de paquetes en un menor costo/tiempo posible. 
  \end{enumerate}
  \item Estrategia de organización: Mejorar el servicio que se ofrece a los clientes.
  \item Escala de valores por la que se rige: obtener el máximo benefício de la gestión de paquetería que la franquicia pueda ofrecer.
\end{enumerate}    \\ \hline
\textsc{Soluciones} & La solución que se propone es desarrollar un sistema que puede calcular de forma inteligente los recursos que posee la empresa, es decir, maximizar la cantidad de paquetes que pueda llevar cada coche o furgoneta según la ruta asignada.\\
\hline
\end{tabularx}
  %\label{tab.OM1}
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      \hline
      \multicolumn{1}{|p{4.0cm}|}{\centering Experiencia en especulación de activos financieros} & \multicolumn{1}{|p{3.0cm}|}{\centering Expertos en especulación en mercados de activos} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 1 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering No, el conocimiento reside en experiencia del experto (inversor).} & Departamento de Análisis & - & \multicolumn{1}{|p{3.0cm}|}{\centering Sí, teniendo en cuenta que son aproximaciones.} \\      
      \hline
      \multicolumn{1}{|p{4.0cm}|}{\centering Teorías de análisis de mercado (La Metodología Wyckoff en Profundidad - \textit{Rubén Villahermosa})} & \multicolumn{1}{|p{3.0cm}|}{\centering Expertos en especulación en mercados de activos} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 1 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering Si, Utilizar la teoría de identificación de tendencias de mercado, identificar los soportes y resistencias dejado por la oscilación del precio al largo del tiempo} & Departamento de Análisis & - & \multicolumn{1}{|p{3.0cm}|}{\centering Sí, teniendo en cuenta que son aproximaciones} \\      
      \hline 
      \multicolumn{1}{|p{4.0cm}|}{\centering Experiencia de gestión por parte del inversor (usuario)} & \multicolumn{1}{|p{3.0cm}|}{\centering Expertos en especulación en mercados de activos} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 2 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering No, el conocimiento reside en el experto (inversor)} &  Departamento de Análisis  & - & \multicolumn{1}{|p{3.0cm}|}{\centering Sí, teniendo en cuenta que son aproximaciones.} \\
      \hline
