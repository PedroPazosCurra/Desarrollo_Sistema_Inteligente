...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      1 & \multicolumn{1}{|p{3.0cm}|}{\centering Recibimiento de los paquetes en la sucursal MRW (entrada)} & \multicolumn{1}{|p{3.0cm}|}{\centering Repartidor experimentado} & \multicolumn{1}{|p{3.0cm}|}{\centering En la nave de la sucursal de MRW} & \multicolumn{1}{|p{3.0cm}|}{\centering No } & No & \multicolumn{1}{|p{3.0cm}|}{\centering Requisito necesario para iniciar el proceso} \\
      \hline
      2 & \multicolumn{1}{|p{3.0cm}|}{\centering Generar lista de entregas según ruta asignada} & \multicolumn{1}{|p{3.0cm}|}{\centering Repartidor experimentado} & \multicolumn{1}{|p{3.0cm}|}{\centering En la nave de la sucursal de MRW} & \multicolumn{1}{|p{3.0cm}|}{\centering Experiencia en reparto de paquetes según la ruta asignada} & Sí (bajo) & Máxima \\
      \hline
...
\begin{table}[H]
  ...
  \resizebox{15,0cm}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      \hline \hline
      \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{Recurso de Conocimiento}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{Pertenece}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{Usado en}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{¿Forma Cor\-recta?}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{¿Lugar Cor\-recto?}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{¿Tiempo Cor\-recto?}} & \multicolumn{1}{|p{3.0cm}|}{\centering \textsc{¿Calidad Cor\-recta?}} \\
      \hline
      
      \multicolumn{1}{|p{3.0cm}|}{\centering Experiencia en reparto de paquetes según la ruta asignada} & \multicolumn{1}{|p{3.0cm}|}{\centering Expertos en reparto} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 2 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering Si, el conocimiento se puede adquirir con sistema de ubicación por código postal.} & \multicolumn{1}{|p{3.0cm}|}{\centering Departamento de logística} & - & \multicolumn{1}{|p{3.0cm}|}{\centering No} \\      
      \hline
      \multicolumn{1}{|p{3.0cm}|}{\centering Utilizar teoría de programación dinámica} & \multicolumn{1}{|p{3.0cm}|}{\centering Experto (director) y equipo directivo} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 3 y 4 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering Sí, la teoría de programación dinámica proporciona unos estándares adecuados.} & \multicolumn{1}{|p{3.0cm}|}{\centering Departamento de logística} & - & \multicolumn{1}{|p{3.0cm}|}{\centering Sí} \\      
      \hline
      \multicolumn{1}{|p{3.0cm}|}{\centering Experiencia en distribución de recursos} & \multicolumn{1}{|p{3.0cm}|}{\centering Experto (director) y equipo directivo} & \multicolumn{1}{|p{3.0cm}|}{\centering Tarea 3 y 4 de OM-3} & \multicolumn{1}{|p{3.0cm}|}{\centering No} & \multicolumn{1}{|p{3.0cm}|}{\centering Departamento de logística} & - & \multicolumn{1}{|p{3.0cm}|}{\centering No}
      \\
      \hline
    \end{tabular}
  }
